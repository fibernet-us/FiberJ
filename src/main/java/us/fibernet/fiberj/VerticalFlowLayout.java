...
public class VerticalFlowLayout extends FlowLayout implements Serializable {
    ...
    public VerticalFlowLayout(int alignment, boolean fillHorizontally,
    ...
    public VerticalFlowLayout(int alignment, int hGap, int vGap,
            boolean fillHorizontally, boolean fillVertically) {
    ...
    private void a(Container container, int i, int j, int k, int l, int i1,
            int j1) {
        int k1 = getAlignment();
        if (k1 == 1) {
            j += l / 2;
